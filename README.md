...
## 📣 Updates
- `2026/07/27` 🔥🔥 Our latest work, Tora3, has been accepted by ACM MM26. Project page: https://ali-videoai.github.io/tora3_page/
- `2026/04/10` Our latest work, [Tora3](https://arxiv.org/abs/2604.09057), is released on arXiv. Tora3 is a trajectory-guided audio-video generation framework that uses object trajectories to jointly guide visual motion and sound, improving physical coherence, motion-sound synchronization, and overall generation quality.
